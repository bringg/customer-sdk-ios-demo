...
//! Project version number for BringgTracking.
FOUNDATION_EXPORT double BringgTrackingFrameworkVersionNumber;

//! Project version string for BringgTracking.
FOUNDATION_EXPORT const unsigned char BringgTrackingFrameworkVersionString[];
