...
//! Project version number for BringgTracking-iOS.
FOUNDATION_EXPORT double BringgTracking_iOSVersionNumber;

//! Project version string for BringgTracking-iOS.
FOUNDATION_EXPORT const unsigned char BringgTracking_iOSVersionString[];
